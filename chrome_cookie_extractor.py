...
def main():
    ...
    # open or create a text file to write the cookie information
    with open('cookies_output.txt', 'w', encoding='utf-8') as output_file:
        for host_key, name, value, creation_utc, last_access_utc, expires_utc, encrypted_value in cursor.fetchall():
            ...
            # write cookie information to the text file
            output_file.write(f"""
            Host: {host_key}
            Cookie name: {name}
